...
export const postSale = async (enrollment: Enrollment, eventSourceUrl: string | undefined, clientIPAddress: string | undefined, clientUserAgent: string | undefined, fbc?: string, fbp?: string): Promise<unknown> => {
