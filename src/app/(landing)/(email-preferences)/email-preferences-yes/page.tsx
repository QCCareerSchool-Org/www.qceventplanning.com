...
const EmailPreferencesYesPage: PageComponent = async props => {
  const { countryCode, lead, jwt, recent, date } = await getThankyouData(props);
  ...
  return (
    <>
      ...
      <EmailPreferencesYesSection countryCode={countryCode} heroSrc={HeroLgImage} mobileHeroSrc={HeroSmImage} leadId={lead?.leadId} telephoneListId={alreadyPrompted ? undefined : telephoneListId} />
