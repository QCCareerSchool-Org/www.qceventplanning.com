            ...
            <div className="row justify-content-center">
              <div className="col-12 col-lg-10">
                ...
                <Question heading="How much does a wedding planner make?">
                  <p>According to Career Explorer, the average entry-level wedding planner salary is about $35,000 per <a href="https://www.careerexplorer.com/careers/wedding-planner/salary/">year</a>. Your income will increase as you gain experience and add additional services such as Event Decor or Floral Design.</p>
                  <p>The global wedding planning industry is estimated to generate USD 899.64 billion <a href="https://www.grandviewresearch.com/industry-analysis/wedding-services-market-report">annually</a>, according to Grand View Research. You can claim a part of that industry and start booking clients in under two months!</p>
                </Question>
