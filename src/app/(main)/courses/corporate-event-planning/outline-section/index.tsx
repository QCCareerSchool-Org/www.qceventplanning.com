        ...
        <div className="col-12 col-xl-10">
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Introduction to Corporate Event Planning</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
          ...
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Working with Venues and Technology</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12 col-lg-6">
                    <ul className="small">
                      <li>Discover tips and tricks for researching venues to ensure find the best possible locations for your clients' events</li>
          ...
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Designing and Executing Corporate Events</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12 col-lg-6">
                    <ul className="small">
                      <li>Learn how to use event design to translate your event concept and branding into the guest experience</li>
                      <li>Discover how to promote your events through multi-channel marketing strategies including web design, SEP and content marketing</li>
          ...
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Event Types  and Evaluation</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12 col-lg-6">
                    <ul className="small">
          ...
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Hands-On Training</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12 col-lg-6">
                    <ul className="small">
          ...
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header><span className="lead fw-bold">Business Training</span></Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12 col-lg-6">
                    <ul className="small">
