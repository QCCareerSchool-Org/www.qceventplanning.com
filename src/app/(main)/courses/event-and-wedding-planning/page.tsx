      ...
      <div className="container">
        ...
        <div className="row mt-s">
          <div className="col-12 col-lg-6">
            <h2>Why Choose<ConditionalBreak xs={false} lg={true} />QC Event School</h2>
            <p>QC's Event & Wedding Planning Certification course provides students with the most comprehensive training available to succeed in the event industry.</p>
            <ul>
