...
const EnrollmentAgreementGBPage: PageComponent = () => {
  ...
  return (
    <div className={styles.terms}>
      ...
      <p>A full refund cannot be granted if you have already submitted course work to your tutor for grading. In this case, a partial refund may be offered instead.</p>
