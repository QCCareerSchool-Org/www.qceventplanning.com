...
const columns = [
  ...
  },
  {
    ...
    heading: <><h3>Other Online Courses &amp; Certificates</h3>(E.g., Penn Foster, IAP, Stratford Career Institute)</>,
  },
...
const rows: ComparisonTableRow<ColumnKey>[] = [
  ...
  },
  {
    ...
    other: <><Heading>Support Roles:</Heading> Foundational knowledge for assistant positions; additional training preferred for business ownership</>,
  },
  {
    ...
    other: 'Self-guided format with online lessons',
  },
  {
    feature: 'Mentorship',
  ...
  },
  {
    ...
    other: 'Varies by program (2 weeks to 6 months)',
  },
  {
    feature: 'Planning Software',
    qc: 'AisplePlanner Included: 6 months free access',
    university: 'Not included',
    other: 'Not included; student discounts may be available',
  },
  {
    ...
    other: <><Heading>Low Cost:</Heading> $149 to $1,500 (Varies by School, Limited Payment Plans)</>,
  },
];
